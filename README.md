...
- **[discuss-with-docs](./skills/engineering/discuss-with-docs/SKILL.md)**: Lead the questions while the agent recommends changes and revises a working design, then choose when to move to grilling or a spec.
